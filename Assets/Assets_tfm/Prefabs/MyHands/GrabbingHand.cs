...
public class GrabbingHand : MonoBehaviour {
	/// <summary>
	/// The player. The Game Object Player to ignore collisions.
	/// </summary>
  ...
  /// <summary>
  /// TFM - Ignores the player collisions.
  /// </summary>
//  private void ignorePlayerCollisions(){
//  	if (player != null)
//			Leap.Utils.IgnoreCollisions(this.gameObject, this.player, true);
//  }

  void Start() {
 		///TFM
//		player = GameObject.FindGameObjectWithTag("Player");
//  	ignorePlayerCollisions();  //too in Update function
