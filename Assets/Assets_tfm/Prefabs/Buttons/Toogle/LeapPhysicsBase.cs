...
namespace LMWidgets
{
  ...
  public abstract class LeapPhysicsBase : MonoBehaviour
  {
    ...
    {
    	///TFM
			//if (m_target == null && State != LeapPhysicsState.Disabled)  //All colliders can interact with the widget
			if (m_target == null && IsHand(collider) && State != LeapPhysicsState.Disabled)   //Only hands can interact with widget
      {
